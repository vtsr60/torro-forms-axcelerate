<?php
/**
 * Template: element-multiplechoicewithtitle.php
 *
	...
	<div>
		...
		<?php $index = 0; foreach ( $choices as $key => $choice ) : ?>
			...
			<div class="torro-toggle">
				<input type="checkbox"<?php echo torro()->template()->attrs( $choice_input_attrs ); ?> value="<?php echo torro()->template()->esc_attr( $key ); ?>"<?php echo in_array( $key, $value, true ) ? ' checked' : ''; ?>>
